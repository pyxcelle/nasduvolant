        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-10 pt-24 pb-32 lg:pt-40 lg:pb-52">
          <div className="max-w-3xl">
            ...
            <div className="mt-16 grid grid-cols-3 gap-8 max-w-xl">
              {[
                { v: "53,85%", l: "Taux de réussite 2024" },
                { v: "5/5", l: "Note Google" },
                { v: "168", l: "Avis clients" },
              ].map((s) => (
                <div key={s.l}>
      ...
      <section className="py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <div className="mt-16 grid gap-6 lg:grid-cols-3">
            {[
              { n: "Léa, 18 ans", q: "Ambiance super, moniteurs à l'écoute, et j'ai eu mon permis du premier coup. Merci !" },
              { n: "Karim, 22 ans", q: "Planning ultra flexible, c'est ce qui m'a permis de jongler avec mes études. Top." },
              { n: "Inès, 17 ans", q: "Conduite accompagnée parfaitement encadrée. On se sent en confiance à chaque leçon." },
            ].map((t) => (
