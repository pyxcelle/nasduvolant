...
const formations = [
  ...
  },
  {
    ...
    sub: "Sans permis · Pratiquer avec ses parents",
    desc: "Vous avez obtenu votre code de la route et effectué vos heures de conduite obligatoires, mais vous souhaitez pratiquer davantage avant votre examen ? La conduite supervisée vous permet de prendre le volant avec un accompagnateur agréé (un parent, par exemple) pour accumuler de l'expérience en conditions réelles. C'est la formule idéale pour gagner en aisance et aborder l'examen pratique avec plus de confiance.",
    points: [
      "Réservé aux élèves ayant validé leur code et leurs heures de conduite",
      "Conduite avec un accompagnateur de votre choix (dès 28 ans)",
      "Pratique en conditions réelles : ville, route, voie rapide",
      "Rendez-vous pédagogiques obligatoires avec votre moniteur",
      "Idéal pour accumuler de l'expérience avant l'examen",
    ],
